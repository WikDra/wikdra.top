...
pscp -batch -P %MIKRUS_PORT% -pw %MIKRUS_PW% index.html panels.html history.html 404.html themes-v5.css bichu.php %EXTRA_FILES% %MIKRUS_USER%@%MIKRUS_HOST%:/home/%MIKRUS_USER%/
