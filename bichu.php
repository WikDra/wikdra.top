        ...
        <header class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-4 w-full"
            ...
            <div>
                ...
                <a href="/" class="text-3xl font-bold hover:opacity-80 transition flex items-center gap-2"
                   :class="{
                     ...
                     'text-[#065f46] font-mono': currentTheme === 'terminal' && currentMode === 'light',
            ...
            <a href="https://wikdra.top" class="text-sm px-4 py-2 border w-fit font-bold flex items-center gap-1.5"
                 :class="{
                   ...
                   'border-4 border-white bg-zinc-800 text-white shadow-[2px_2px_0_#fff] hover:shadow-[4px_4px_0_#fff] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all': currentTheme === 'brutalist' && currentMode === 'dark',
                   ...
                   'border-emerald-600/20 bg-white text-[#065f46] font-mono hover:bg-emerald-50': currentTheme === 'terminal' && currentMode === 'light',
                ...
                <div class="flex gap-4">
                    ...
                    <button @click="editMode = false" 
                            ...
                            :class="{
                              ...
                              'border border-emerald-600/20 bg-white text-[#065f46] hover:bg-emerald-50 rounded': currentTheme === 'terminal' && currentMode === 'light',
    ...
    <div x-data="{ open: false }" class="fixed bottom-5 right-5 z-50 font-sans">
        ...
        <div x-show="open" 
             ...
             :class="{
               ...
               'border-4 border-white bg-[#18181b] text-white shadow-[6px_6px_0_#fff]': currentTheme === 'brutalist' && currentMode === 'dark',
               ...
               'border border-emerald-600/30 bg-[#f4faf4] text-[#065f46]': currentTheme === 'terminal' && currentMode === 'light',
             ...
             <div class="flex p-0.5"
                 ...
                 <button @click="currentMode = 'dark'"
                         ...
                         :class="{
                           ...
                           'bg-white text-black rounded-none': currentMode === 'dark' && currentTheme === 'brutalist' && currentMode === 'dark',
