        ...
        <header class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-4 w-full"
            ...
            <a href="https://wikdra.top" class="text-sm px-4 py-2 border w-fit font-bold flex items-center gap-1.5"
                 :class="{
                   ...
                   'border-4 border-[#bef264] bg-zinc-800 text-white shadow-[2px_2px_0_#bef264] hover:shadow-[4px_4px_0_#bef264] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all': currentTheme === 'brutalist' && currentMode === 'dark',
    ...
    <div x-data="{ open: false }" class="fixed bottom-5 right-5 z-50 font-sans">
        ...
        <div x-show="open" 
             ...
             :class="{
               ...
               'border-4 border-[#bef264] bg-[#18181b] text-white shadow-[6px_6px_0_#bef264]': currentTheme === 'brutalist' && currentMode === 'dark',
